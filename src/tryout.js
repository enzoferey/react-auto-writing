...
var addAttr = require("./add-attribute-plugin.js");
...
console.log(babel.transform('<div><Habak /><Habak data-cy="to-be-removed"/></div>', {presets: ["react"], plugins: [[addAttr, { "label": "data-inspector" }]]}).code);